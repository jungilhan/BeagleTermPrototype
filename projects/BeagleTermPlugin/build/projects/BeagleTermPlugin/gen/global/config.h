...
#define FBSTRING_CompanyName "Monkey Labs"
#define FBSTRING_PLUGIN_VERSION "1.0.0.0"
#define FBSTRING_LegalCopyright "Copyright 2011 Monkey Labs"
#define FBSTRING_PluginFileName "npBeagleTermPlugin.dll"
#define FBSTRING_ProductName "Beagle Term Plugin"
#define FBSTRING_PluginName "Beagle Term Plugin"
...
#define FBSTRING_MIMETypeList "application/x-beagletermplugin"

#define FBSTRING_MIMEType0 "application/x-beagletermplugin"
#define FBSTRING_X11MIMEType0 "application/x-beagletermplugin::Beagle Term is a chrome-based SSH client."
#define FBSTRING_FileDescription0 "Beagle Term is a chrome-based SSH client."
